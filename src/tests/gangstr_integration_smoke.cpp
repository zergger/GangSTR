...
int main() {
  ...
  flanking_class.AddData(10);
  flanking_class.AddData(14);
  ...
  if (!NearlyEqual(ll_without_model, ll_with_model, 1e-12)) {
    std::cerr << "flanking likelihood changed when stutter model was provided" << std::endl;
